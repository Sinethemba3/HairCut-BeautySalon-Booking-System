                    ...
                    <div class="account_form shadow-lg p-4 border-0 rounded" data-aos="fade-up" data-aos-delay="0">
                        <form method="post" action="">
                            ...
                            <div class="text-center mb-4">
                                ...
                                <h3 class="auth-title mt-3" style="color: #333;">Forgot Password</h3>

                                <p class="auth-subtitle text-muted">Enter your Email to Reset your account.</p>
                            </div>

                            <?php if(!empty($errors['email'])) : ?>
                                <div class="text-danger pb-2" style="font-weight: lighter; font-size: 0.8rem;"> <?=$errors['email']?> </div>
                            <?php endif; ?>
                            ...
                            <div class="login_submit ">
                                <button class="btn btn-md btn-block btn-black-default-hover mb-4" type="submit">Continue</button>
                            </div>
                        </form>
                    </div>
                </div>
