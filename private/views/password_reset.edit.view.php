   ...
   <!-- ...:::: Start Customer Login Section :::... -->
                    ...
                    <div class="account_form shadow-lg p-4 border-0 rounded" data-aos="fade-up" data-aos-delay="0">
                        <form method="post" action="">
                            ...
                            <div class="text-center mb-4">
                                ...
                                <h3 class="auth-title mt-3" style="color: #333;">Reset Password</h3>
                                <p class="auth-subtitle text-muted">Reset your account to get started.</p>
                            </div>

                            <!-- Password Field with Toggle -->
                            <?php if(!empty($errors['password'])) : ?>
                                <div class="text-danger pb-2" style="font-weight: lighter; font-size: 0.8rem;"> <?=$errors['password']?> </div>
                            <?php endif; ?>
                            ...
                            <?php if(!empty($errors['password2'])) : ?>
                                <div class="text-danger pb-2" style="font-weight: lighter; font-size: 0.8rem;"> <?=$errors['password2']?> </div>
                            <?php endif; ?>
                            
                            <div class="default-form-box position-relative">
                                <input 
                                    value="<?= get_var('password2') ?>" 
                                    type="password" 
                                    name="password2" 
                                    id="login-password2" 
                                    class="form-control line-input" 
                            ...
                            <div class="login_submit ">
                                <button class="btn btn-md btn-block btn-black-default-hover mb-4" type="submit">Reset Password</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // Show/hide password toggle for password1
            ...
            // ✅ Show/hide password toggle for password2
            document.getElementById("toggle-password2").addEventListener("click", function () {
                const passInput2 = document.getElementById("login-password2");
