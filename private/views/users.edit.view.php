                                    ...
                                    <div class="col-sm-12">
                                        <form  onsubmit="validate(event, this)"method="post" id="frmContactus" enctype="multipart/form-data">
                                            <div class="text-center" > 
                                                <label>
                                                    <?php $image =  fetch_image($row[0]->image, $row[0]->gender); ?>
                                            ...
                                            <div class="row ">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input style="font-size: 0.8rem;" class="form-control" type="text" name="name" id="name" value="<?=get_var('name', $row[0]->name)?>" placeholder="Enter Name">
                                                </div>

                                                <div class="form-group col-md-6">
                                                    <label for="lname" style="font-size: 0.8rem;"> Surname</label>
                                                    <input style="font-size: 0.8rem;" class="form-control" type="text" name="surname" id="surname" value="<?=get_var('surname', $row[0]->surname)?>" placeholder="Enter Surname">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row ">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input style="font-size: 0.8rem;" class="form-control" type="email" name="email" id="email" value="<?=get_var('email', $row[0]->email)?>" placeholder="Enter Email">
                                                </div>

                                                <div class="form-group col-md-6">
                                                    <label for="lname" style="font-size: 0.8rem;"> Gender</label>
                                                    <input style="font-size: 0.8rem;" class="form-control" type="text" name="gender" id="gender" value="<?=get_var('gender', $row[0]->gender)?>" placeholder="Enter password">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row ">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input style="font-size: 0.8rem;" class="form-control" type="text" name="user_type" id="user_type" value="<?=get_var('role', $row[0]->role)?>" placeholder="Enter Email">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="lname" style="font-size: 0.8rem;"> Birthday</label>
                                                    <input style="font-size: 0.8rem;" class="form-control" type="text" name="user_type" id="user_type" value="<?=get_var('birthday', $row[0]->birthday)?>" placeholder="Enter Email">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row ">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input style="font-size: 0.8rem;" class="form-control" type="password" name="password" id="password" value="" placeholder="Enter password">
                                                </div>

                                                <div class="form-group col-md-6">
                                                    <label for="lname" style="font-size: 0.8rem;"> Confirm Password</label>
                                                    <input style="font-size: 0.8rem;" class="form-control" type="password" name="password2" id="password2" value="" placeholder="Confirm password">
                                                </div>
                                            </div>

                                            <div class="modal-footer">
                                                <button class="btn btn-primary" type="submit" data-dismiss="modal">Update</button>
                                                <a href="<?=ROOT?>/users/<?=$row[0]->user_id?>">
