 <?php $this->view('includes/bookings_header'); ?>
    ...
    <style>
        ...
        .service-filters button:hover {
            background: #2563eb; /* Lighter blue on hover/active */
            color: #fff;
        }
    ...
    <div id="bookings" class="service-promo-section">
        <!-- Start Services Content Text Area -->
        <div class="main-menu section-title-wrapper py-5 my-5 bg-light rounded-4 shadow-sm" data-aos="fade-up" data-aos-delay="0">
        ...
        <div class="container pt-4">
            <div class="service-filters" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="row justify-content-center align-items-center">
                    <?php if (!empty($rowz)): ?>
                        <?php foreach ($rowz as $row): ?>
                            <div class="col-lg-3 col-sm-6 col-6 card-item" data-cat="<?= strtolower($row->services) ?>" data-aos="fade-up" data-aos-delay="400">
    ...
    <script>
        ...
        function setBranch(branch) {
            ...
            if (btn) {
                ...
                btn.href = `<?= ROOT ?>/bookingServices?mode=${selectedService}&branch=${selectedBranch}`;
            }
        }
        ...
        function setBranch(branch, btn) {
            ...
            if (serviceBtn) {
                ...
                serviceBtn.href = `<?= ROOT ?>/bookingServices?mode=${selectedService}&branch=${selectedBranch}`;
            }
